 ...
 */
	 ...
	 * @return GridPane
	 */
	private GridPane setUpModifyPane() {
	 ...
	 */
	private void setUploadAction(Label personPhoto) {
	 ...
	 */
	private void setSubmitAction(Person selectedPerson, TextField personAge, ToggleGroup personGender,
			TextField personStatus, ComboBox<String> comboBox, Label personPhoto) {
	 ...
	 */
	private void setOriginalData(Person selectedPerson, Label personName, TextField personAge, RadioButton female,
			RadioButton male, TextField personStatus, ComboBox<String> comboBox, Label personPhoto) {
	 ...
	 */
	private void updateProfileInfo(Person currentPerson, String photo, String status, String gender, int age,
			String state) {
